...
let product = {제품명: name , 가격: price , 제조사: brand}
console.log(product)
*/
...
let find = false ; //중복여부 체크 변수 , true 중복 , false : 중복아님 , 스위치변수 = on/off = 맞다/아니다
