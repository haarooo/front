...
//스왑 : 변수는 하나의 자료(값)만 저장한다, 연산은 동시에 이뤄지지 않는다(하나씩 처리한다)
//방법 : 임시저장소: temp변수를 활용한다 a와 b의 값 스왑, temp =a; b=a; a=temp;
//오름차순 : 작은것 -> 큰것 / 날짜 : 과거날짜 -> 최근날짜 
/*
let a =Number(prompt(" a input : "))
let b =prompt(" b input : ")
let c =prompt(" c input : ")
// 비교 //
if(a > b){ let temp = a ; a = b ; b = temp } //내림차순 : a<b  
...
//경우의수 : 승리(0 == 2 , 1 == 0 , 2 == 1) 패배(그외) 무승부( 0 == 0, 1 == 1, 2==2)
//경우의수2 : 플레이어1 == (플레이어2 +1 % 3) 3(2+1) % 3 ==0, 1(0+1) % 3 == 1, 2(1+1) % 3 ==2
...
//배열 indexof(입력받은 제외과목명); 배열명.sclice(삭제할 인덱스 , 1);